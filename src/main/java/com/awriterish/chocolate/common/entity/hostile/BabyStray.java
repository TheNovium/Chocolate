...
public class BabyStray extends Stray {
    ...
    public BabyStray(EntityType<? extends Stray> entity, Level level){
        super(entity, level);
    ...
    protected void populateDefaultEquipmentSlots(DifficultyInstance difficulty) {
        ...
        this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(Items.STONE_SHOVEL));
    ...
    public void tick() {
        ...
        if(!this.level.isClientSide){
            ...
            if(this.weaponSwitchCoolDown == 0){
                ...
                } else if((this.getTarget() == null || this.distanceTo(this.getTarget()) > 7.0d) && this.getMainHandItem().getItem() instanceof ShovelItem){
                    this.switchMainAndOffHand();
                }
            }
        }
